      ...
      <header id="page-header">
        ...
        <div class="content-header">
          ...
          <div class="space-x-1 d-flex align-items-center space-x-2">
            ...
            <!-- Version -->
            <span class="d-inline-block fs-xs fw-medium bg-primary-dark text-white rounded-pill py-1 px-2">5.10</span>
            <!-- END Version -->
          </div>
          <!-- END Left Section -->
            ...
            <div class="dropdown">
              ...
              <div class="dropdown-menu dropdown-menu-end fs-sm p-0" aria-labelledby="landing-themes-dropdown">
                ...
                <div class="p-2">
                  ...
                  <button class="dropdown-item d-flex align-items-center justify-content-between fw-medium" data-toggle="theme" data-theme="assets/css/themes/elegance.min.css">
                    <span>Elegance</span>
                    <i class="fa fa-circle text-elegance"></i>
                  </button>
                  <button class="dropdown-item d-flex align-items-center justify-content-between fw-medium" data-toggle="theme" data-theme="assets/css/themes/pulse.min.css">
                    <span>Pulse</span>
                  ...
                  <button class="dropdown-item d-flex align-items-center justify-content-between fw-medium" data-toggle="theme" data-theme="assets/css/themes/Corporate.min.css">
                    <span>Corporate</span>
                    <i class="fa fa-circle text-corporate"></i>
                  </button>
                  <button class="dropdown-item d-flex align-items-center justify-content-between fw-medium" data-toggle="theme" data-theme="assets/css/themes/earth.min.css">
                    <span>Earth</span>
              ...
              <div class="row g-6 w-100 py-7 overflow-hidden">
                ...
                <div class="col-md-6 py-4 d-flex align-items-center">
                  <div class="text-center text-md-start">
                    ...
                    <a class="btn btn-primary py-2 px-3" href="be_pages_dashboard.html" target="_blank">
                      Live Preview
